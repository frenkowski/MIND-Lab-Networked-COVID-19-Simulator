...
def create_all_graphs(dict_upload_files, save_pdf = False):
	...
	if len(dict_upload_files.keys()) == 0:
		...
		table = [	
					...
					dash_table.DataTable(
					    columns=[{"name": i, "id": i} for i in ['sim_name','R_0', 'n_of_families', 'number_of_steps', 'incubation_days', 'infection_duration', 'n_initial_infected_nodes', 'R_0']],
					    data= table_values,
